...
console.log('Type of "myFunc" = ', typeof myFunc) // 함수는 object 자료형이지만 'function' 이라 출력됨

console.log("Is 'a' an array? ", Array.isArray(a))    // a는 배열?
console.log("Is 'b' an array? ", Array.isArray(b))    // b는 배열?

a.newProperty = 123   // 배열은 object이므로 속성을 추가할 수 있다. 일반적인 원소와는 다르게 취급됨
...
// 기본 자료형이 더 이상 아님.  new 키워드 주목
console.log('\nBasic types as objects examples:')
const x = new Number(123)   // 객체 (Number 객체)
...
x.newProperty = 123   // object이므로 속성 추가 가능
y.newProperty = 123   // object이므로 속성 추가 가능
z.newProperty = 123   // object이므로 속성 추가 가능
console.log('x = ', x)
console.log('y = ', y)
console.log('z = ', z)
console.log('x.valueOf() = ', x.valueOf())
