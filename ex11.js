...
const z = 'I like JavaScript' // 문자열 기본 자료형 정수
console.log('z = ', z)
// console.log(' "length" in z ? ', 'length' in z)   // length 속성의 포함여부, 오류 발생!!


// 삼항 조건 연산자
console.log('\nTernary operator examples:')
let myAge = 22
let myDrink = (myAge >= 20) ? 'beer' : 'coke'  // 조건 ? 참일때 실행할 값 : 거짓일때 실행할 값
...
// 단축 평가 (Short circuit).
console.log('\nShort circuit evaluation exammples:')
myAge = 22
myAge >= 20 && console.log('You are grown up!')   // 왼쪽 조건이 true이면 오른쪽 실행
myAge >= 20 || console.log('You are still hungry.')   // 왼쪽 조건이 false이면 오른쪽 실행
myAge = 17
myAge >= 20 && console.log('You are grown up!')   // 왼쪽 조건이 true이면 오른쪽 실행
myAge >= 20 || console.log('You are still hungry.') // 왼쪽 조건이 false이면 오른쪽 실행