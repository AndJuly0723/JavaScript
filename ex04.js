...
e = [1, 2, ['Life', 'is']]    // 배열 안의 또 다른 배열

console.log('Type of "a" : ', typeof a)   // object 라고 출력됨. 배열과 객체를 구별하지못함
console.log('Is "a" an array? ', Array.isArray(a))    // Array.isArray() 함수를 사용해서 array 여부 확인가능
console.log('a = ', a)
console.log('b = ', b)
console.log('c = ', c)
console.log('d = ', d)
...
console.log(a.slice(0,2))   // 인덱스0번 ~ 인덱스1번까지  // 0 ~ 2(미포함).
console.log(a.slice(2))   // 인덱스2번부터 ~ 끝까지
console.log(a.slice(-2))    // 끝에서 두개.
